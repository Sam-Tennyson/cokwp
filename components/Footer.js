...
<footer className="p-4 sticky  bottom-0 inset-x-0 shadow flex items-center flex-col justify-between md:flex md:items-center md:justify-between md:p-6 md:flex-row dark:bg-gray-800 sm:flex sm:item-center sm:justify-between">
