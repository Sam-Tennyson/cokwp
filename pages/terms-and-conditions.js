...
const Terms = () => {
  return (
    <>
      <h2 className="sm:text-2md md:text-2xl text-5sm lg:text-2xl  font-bold my-5">
        <strong>Terms and Conditions</strong>
      </h2>

      <p className="text-justify">
        <strong>Welcome to COKWP!</strong>
      </p>
      ...
      <p className="text-justify">
        ...
        conditions. Do not continue to use COKWP if you do not agree to take all
      ...
      <p className="text-justify">
        ...
        the Company terms and conditions. The Company, Ourselves, We,
      ...
      <h3 className="sm:text-md md:text-xl text-5sm lg:text-xl  font-bold my-5">
        <strong>Cookies</strong>
      </h3>

      <p className="text-justify">
        We employ the use of cookies. By accessing COKWP, you agreed to use
        cookies in agreement with the COKWP&apos Privacy Policy.{" "}
      </p>
      ...
      <ul>
        <li>Republish material from COKWP</li>
        <li>Sell, rent or sub-license material from COKWP</li>
        <li>Reproduce, duplicate or copy material from COKWP</li>
        <li>Redistribute content from COKWP</li>
      </ul>
      ...
      <p className="text-justify">
        COKWP reserves the right to monitor all Comments and to remove any
        Comments which can be considered inappropriate, offensive or causes
        breach of these Terms and Conditions.
      </p>

      <p className="text-justify">You warrant and represent that:</p>
      ...
      <p className="text-justify">
        You hereby grant COKWP a non-exclusive license to use, reproduce, edit
      ...
      <p className="text-justify">
        ...
        the hyperlink compensates the absence of COKWP; and (d) the link is in
      ...
      <p className="text-justify">Please read Privacy Policy</p>
