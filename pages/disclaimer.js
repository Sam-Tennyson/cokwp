...
<h2 className="sm:text-md md:text-xl text-5sm lg:text-xl  font-bold my-5">Consent</h2>
 ...
 <p className="text-justify">By using our website, you hereby consent to our disclaimer and agree to its terms.</p>

<h2 className="sm:text-md md:text-xl text-5sm lg:text-xl  font-bold my-5">Update</h2>

 <p className="text-justify">Should we update, amend or make any changes to this document, those changes will be prominently posted here.</p>
    </>
  )
}
