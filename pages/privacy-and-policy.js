  ...
  return (
    <>
      ...
      <p className="text-justify">
        ...
        types of information that is collected and recorded by COKWP and how we
        use it.
      </p>
      ...
      <h2 className="sm:text-md md:text-xl text-5sm lg:text-xl  font-bold my-5">Consent</h2>
      ...
      <h2 className="sm:text-md md:text-xl text-5sm lg:text-xl  font-bold my-5">Information we collect</h2>
      ...
      <h2 className="sm:text-md md:text-xl text-5sm lg:text-xl  font-bold my-5">How we use your information</h2>
      ...
      <h2 className="sm:text-md md:text-xl text-5sm lg:text-xl  font-bold my-5">Log Files</h2>

      <p className="text-justify">
        COKWP follows a standard procedure of using log files. These files log
      ...
      <h2 className="sm:text-md md:text-xl text-5sm lg:text-xl  font-bold my-5">Our Advertising Partners</h2>
      ...
      <p className="text-justify">
        ...
        advertisements and links that appear on COKWP, which are sent directly
      ...
      <p className="text-justify">
        Note that COKWP has no access to or control over these cookies that are
        used by third-party advertisers.
      </p>

      <h2 className="sm:text-md md:text-xl text-5sm lg:text-xl  font-bold my-5">Third Party Privacy Policies</h2>
      ...
      <p className="text-justify">
        Request that a business that collects a consumer&apos personal data
      ...
      <p className="text-justify">
        Request that a business that sells a consumer&apos personal data, not sell
        the consumer&apos personal data.
      </p>
      <p className="text-justify">
      ...
      <h2 className="sm:text-md md:text-xl text-5sm lg:text-xl  font-bold my-5">GDPR Data Protection Rights</h2>
      ...
      <p className="text-justify">
        COKWP does not knowingly collect any Personal Identifiable Information
